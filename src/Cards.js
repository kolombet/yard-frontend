  ...
  render() {
    return (
      <section className="container">
        <Card title="SOUTH BEACH, SAN FRANCISCO" address="764 Metropolitan Avenue" description="The Lewis Steel Building is a masterful industrial conversion located in
