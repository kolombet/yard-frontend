          ...
          <div className="row">
            ...
            <div className="col-md-6">
              <div className="guide-navigation">
                <GuideItem title="Красный Октябрь" details="24 минуты, 6 км"/>
                <GuideItem title="World class" details="2 минуты, 300 м"/>
                <GuideItem title="Третьяковская галерея" details="14 минут, 4 км"/>
              </div>
            </div>
          </div>
        </div>
